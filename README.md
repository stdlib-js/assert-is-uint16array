...
```javascript
isUint16Array = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-uint16array@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-uint16array@umd/bundle.js"></script>
```
